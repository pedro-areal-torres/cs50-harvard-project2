document.addEventListener('DOMContentLoaded', () => {
    ...
    // Check users last active channel
    ...
    // Renders content of the active channel 
    ...
    socket.on('connect', () => {
        ...
        document.querySelector('#msg-form').onsubmit = () => {
            ...
            const time = today.toLocaleString('default', { hour: 'numeric', minute: 'numeric', hour12: false });
